...
{
    /// <inheritdoc />
    public partial class mig_tabllecreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SocaialMedia1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SocaialMedia2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SocaialMedia13 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Testimpnials", x => x.TestimonialID);
                });
        }
